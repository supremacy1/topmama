...
<head>
	...
	<link href="../../../../css2?family=Oswald:wght@200;300;400;500;600;700&display=swap" rel="stylesheet">
	<link href="../../../../css2-1?family=Lilita+One&display=swap" rel="stylesheet">

	<!-- BOOTSTRAP CSS -->
	<link href="css/bootstrap.min.css" rel="stylesheet">

	<!-- FONT ICONS -->
	<link href="../../../../releases/v5.11.0/css/all.css" rel="stylesheet" crossorigin="anonymous">
	...
	<script>
		...
		function displayProducts(products) {
			...
			products.forEach(product => {
				...
				mainImage.src = `data:image/jpeg;base64,${product.images[0].data}`;
				mainImageDiv.appendChild(mainImage);
				productDiv.appendChild(mainImageDiv);
				...
				product.images.forEach((image, index) => {
					...
					// Click event to show clicked image as main image
					img.addEventListener('click', () => {
						mainImage.src = `data:image/jpeg;base64,${image.data}`;
					});
...
<body>
		...
		<div class="blockChanger bgChanger">
			...
			<div class="chBody white-color">
				...
				<div class="stBlock text-center" style="margin: 30px 20px 20px 26px">
					<p>Choose Demo</p>
					<a class="s_1" href="demo-1.html"><img src="images/color-scheme/l-01.jpg" width="180" height="93"
							alt="layout-image"></a>
					<a class="s_1" href="demo-2.html"><img src="images/color-scheme/l-02.jpg" width="180" height="130"
							alt="layout-image"></a>
					<a class="s_1" href="demo-3.html"><img src="images/color-scheme/l-03.jpg" width="180" height="98"
							alt="layout-image"></a>
					<a class="s_1" href="demo-4.html"><img src="images/color-scheme/l-04.jpg" width="180" height="115"
							alt="layout-image"></a>
					<a class="s_1" href="demo-6.html"><img src="images/color-scheme/l-06.jpg" width="180" height="93"
							alt="layout-image"></a>
					<a class="s_1" href="demo-7.html"><img src="images/color-scheme/l-07.jpg" width="180" height="121"
							alt="layout-image"></a>
					<a class="s_1" href="demo-8.html"><img src="images/color-scheme/l-08.jpg" width="180" height="115"
							alt="layout-image"></a>
					<a class="s_1" href="demo-9.html"><img src="images/color-scheme/l-09.jpg" width="180" height="109"
							alt="layout-image"></a>
					<a class="s_1" href="demo-10.html"><img src="images/color-scheme/l-10.jpg" width="180" height="125"
							alt="layout-image"></a>
					<a class="s_1" href="demo-11.html"><img src="images/color-scheme/l-11.jpg" width="180" height="128"
							alt="layout-image"></a>
					<a class="s_1" href="demo-12.html"><img src="images/color-scheme/l-12.jpg" width="180" height="123"
							alt="layout-image"></a>
				</div>
			...
			<div class="navik-header-container">
				...
				<nav class="navik-menu menu-caret navik-yellow">
					<ul class="top-list">
						...
						<!-- DROPDOWN MENU -->
						<li><a href="#">Our Offer</a>
							<ul>
								<li><a href="menu-1.html">Pizza</a></li>
								<li><a href="menu-2.html">Small Chops</a></li>
	...
	<div id="page" class="page">
								...
								<div class="row text-center">
									...
									<div class="col-sm-3">
										<div class="abox-2">
											...
											<!-- Icon -->
											<div class="abox-2-ico"><span class="flaticon-dinner"></span></div>

											<!-- Text -->
											<h6 class="h6-lg">Pasta</h6>
									...
									<div class="col-sm-3">
										<div class="abox-2">
											...
											<!-- Icon -->
											<div class="abox-2-ico"><span class="flaticon-salad"></span></div>
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="section-title mb-60 text-center">
							...
							<!-- Title 	-->
							<h2 class="h2-xl red-color">From Italy, With Love</h2>
						...
						<a href="product-single.html">
							<div id="pb-5-1" class="pbox-5 bg-lightgrey">
								<div class="pbox-5-txt">
									...
									<!-- Title -->
									<h4 class="h4-xs coffee-color">Buffalo Chicken Pizza</h4>

									<!-- Item Code -->
									<span class="item-code">Code: 1039</span>

									<!-- Image -->
									<div class="pbox-5-img text-center mt-25 rel">

										<!-- Image -->
										<img class="img-fluid" src="images/menu/pizza-04.png" alt="promo-image">

										<!-- Price Badge -->
										<div class="price-badge-sm bg-fixed">
											<div class="badge-txt">
												<h5 class="h5-sm">Only</h5>
												<h4 class="h4-md">$11.99</h4>
											</div>
										</div>
						...
						<a href="product-single.html">
							<div id="pb-5-2" class="pbox-5">
								<div class="pbox-5-txt">
									...
									<!-- Title -->
									<h4 class="h4-xs coffee-color">Prosciutto & Arugula Pizza</h4>

									<!-- Item Code -->
									<span class="item-code">Code: 1046</span>

									<!-- Image -->
									<div class="pbox-5-img text-center mt-25">
										<img class="img-fluid" src="images/menu/pizza-06.png" alt="promo-image">
									</div>

									<!-- Price -->
									<div class="pbox-5-price">
										<p>Small 12" <span class="red-color"> $12.45</span></p>
										<p>Large 16" <span class="red-color"> $20.95</span></p>
									</div>
						...
						<a href="product-single.html">
							<div id="pb-5-3" class="pbox-5">
								<div class="pbox-5-txt">
									...
									<!-- Title -->
									<h4 class="h4-xs coffee-color">Spicy BBQ Chicken Pizza</h4>

									<!-- Item Code -->
									<span class="item-code">Code: 1050</span>

									<!-- Image -->
									<div class="pbox-5-img text-center mt-25">
										<img class="img-fluid" src="images/menu/pizza-03.png" alt="promo-image">
									</div>

									<!-- Price -->
									<div class="pbox-5-price">
										<p>Small 12" <span class="red-color"> $13.99</span></p>
										<p>Large 16" <span class="red-color"> $23.45</span></p>
									</div>
		...
		<!-- MENU-9
			============================================= -->
		<section id="menu-9" class="wide-50 menu-section division">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="menu-7-item">
							...
							<div class="menu-7-img rel">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/menu/side-01.png" alt="menu-image">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="menu-7-item">
							...
							<div class="menu-7-img rel">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/menu/side-02.png" alt="menu-image">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="menu-7-item">
							...
							<div class="menu-7-img rel">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/menu/side-03.png" alt="menu-image">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="menu-7-item">
							...
							<div class="menu-7-img rel">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/menu/side-04.png" alt="menu-image">
					...
					<div class="col-md-6 col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-post-txt">
								...
								<!-- Post Title -->
								<h5 class="h5-lg coffee-color"><a href="single-post.html">Quaerat neque purus ipsum
										neque dolor</a></h5>
					...
					<div class="col-md-6 col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-post-txt">
								...
								<!-- Post Title -->
								<h5 class="h5-lg coffee-color"><a href="single-post.html">Tempor blandit sapien at
					...
					<div class="col-md-6 col-lg-4">
						<div class="blog-post">
							...
							<div class="blog-post-txt">
								...
								<!-- Post Title -->
								<h5 class="h5-lg coffee-color"><a href="single-post.html">Neque dolor primis a libero
										tempus a tempor</a></h5>

								<!-- Post Text -->
								<p class="grey-color">Impedit tempor at donec sapien ipsum a neque dolor primis libero
								</p>
							...
							<ul class="slides text-center">
								...
								<li class="review-1">
									<div class="review-1-txt">
										...
										<!-- Text -->
										<p>" Etiam sapien sem at sagittis congue augue massa varius sodales sapien undo
											tempus dolor
											egestas magna suscipit magna tempus aliquet porta sodales augue suscipit
											luctus neque "
										</p>
								...
								<li class="review-1">
									<div class="review-1-txt">
										...
										<!-- Text -->
										<p>" At sagittis congue augue egestas egestas magna ipsum vitae purus ipsum
											primis in cubilia
											laoreet augue egestas luctus donec diam ociis nullam tempor sapien, eget
											orci gravida porta "
										</p>
								...
								<li class="review-1">
									<div class="review-1-txt">
										...
										<!-- Text -->
										<p>" Mauris donec ociis et magnis sapien etiam sapien sem sagittis congue augue.
											An orci nullam
											tempor sapien, eget orci gravida donec enim ipsum porta justo integer at
											odio velna auctor "
										</p>
								...
								<li class="review-1">
									<div class="review-1-txt">
										...
										<!-- Text -->
										<p>" An orci nullam tempor sapien, eget orci gravida donec enim ipsum porta
											justo integer at
											odio velna auctor. Egestas magna ipsum vitae purus ipsum primis in cubilia
											laoreet augue "
										</p>
								...
								<li class="review-1">
									<div class="review-1-txt">
										...
										<p>" Egestas egestas magna ipsum vitae purus efficitur ipsum primis in cubilia
											laoreet augue
											egestas luctus donec ociis vitae purus diam integer congue magna undo
											impedit lacus dolor "
										</p>
		...
		<section id="promo-7" class="wide-100 promo-section division">
			<div class="container">
				...
				<div class="row d-flex align-items-center">
						...
						<div class="pbox-7 clearfix">
							...
							<div class="pbox-7-img rel">
								<div class="hover-overlay">
									...
									<!-- Image -->
									<img class="img-fluid" src="images/img-01.jpg" alt="promo-image">
							...
							<div id="pb-7-1" class="pbox-7-txt rel">
								...
								<!-- Title -->
								<h4 class="h4-xs coffee-color">Fried Seafood</h4>

								<!-- Text -->
								<p class="grey-color">Vitae sapien justo aliquet purus molestie a semper lacus at cursus
									porta lobortis</p>
					...
					<!-- PROMO BOX-2 -->
					<div class="col-lg-4">
						<div class="pbox-7 clearfix m-row">

							<!-- Text -->
							<div id="pb-7-2" class="pbox-7-txt rel m-bottom">
								...
								<!-- Title -->
								<h4 class="h4-sm coffee-color">Crispy Chicken</h4>

								<!-- Text -->
								<p class="grey-color">Vitae sapien justo aliquet molestie purus a semper lacus at cursus
									porta lobortis</p>

								<!-- Price -->
								<div class="pbox-7-price">
									<h5 class="h5-lg red-color"><span class="old-price">$13.79</span> $11.25</h5>
								</div>
							...
							<!-- Image -->
							<div class="pbox-7-img rel m-top">
								<div class="hover-overlay">

									<!-- Image -->
									<img class="img-fluid" src="images/img-02.jpg" alt="promo-image">

									<!-- Item Code -->
									<span class="item-code bg-tra-dark">Code: 2136</span>

									<!-- Zoom Icon -->
									<div class="menu-img-zoom ico-25">
										<a href="images/img-02.jpg" class="image-link">
											<span class="flaticon-zoom"></span>
										</a>
									</div>
						...
						<div class="pbox-7 clearfix">
							...
							<div class="pbox-7-img rel">
								<div class="hover-overlay">
									...
									<!-- Image -->
									<img class="img-fluid" src="images/img-03.jpg" alt="promo-image">

									<!-- Item Code -->
									<span class="item-code bg-tra-dark">Code: 2164</span>

									<!-- Zoom Icon -->
									<div class="menu-img-zoom ico-25">
										<a href="images/img-03.jpg" class="image-link">
											<span class="flaticon-zoom"></span>
										</a>
									</div>
							...
							<!-- Text -->
							<div id="pb-7-3" class="pbox-7-txt rel">
								...
								<!-- Title -->
								<h4 class="h4-sm coffee-color">French Fries</h4>
								...
								<!-- Price -->
								<div class="pbox-7-price">
									<h5 class="h5-lg red-color"><span class="old-price">$5.45</span> $4.49</h5>
								</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-5">
							<div class="promo-12-txt">
								...
								<h3>From <span class="red-color">$13.99</span></h3>
						...
						<div class="col-lg-7">
							<div class="promo-12-img text-center">
								...
								<!-- Image -->
								<img class="img-fluid" src="images/promo-12-img.png" alt="promo-image">

								<!-- Discount Badge -->
								<div class="discount-badge">
									<img src="images/discount-badge-red.png" alt="promo-image">
								</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-01.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-01.jpg" alt="gallery-image">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-02.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-02.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-03.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-03.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-04.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-04.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-05.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-05.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-06.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-06.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-07.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-07.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="gallery-img">
							<a href="images/gallery/img-08.jpg" class="image-link">
								<div class="hover-overlay">
									<img class="img-fluid" src="images/gallery/img-08.jpg" alt="gallery-image">
									<div class="item-overlay"></div>
		...
		<!-- BANNER-1
			============================================= -->
		<section id="banner-1" class="bg-fixed banner-section division">
			<div class="container">
				<div class="row">
					...
					<!-- BANNER TEXT -->
					<div class="col-lg-10 offset-lg-1">
						<div class="banner-1-txt white-color">

							<!-- Title -->
							<h2 class="h2-lg">Covid-19 Update</h2>

							<!-- Text -->
							<p class="p-lg">We take the safety of our staff and customers very seriously and are doing
								all we can
								to operate in the safest manner possible. Here are the safety measures being taken
							...
							<ul class="txt-list">
								<li>
									<p class="p-lg">Masks and gloves for all employees at all times</p>
								</li>
								<li>
									<p class="p-lg">Social distancing inside the shop to the best of our ability</p>
								</li>
								<li>
									<p class="p-lg">Glove change/hand washing every hour</p>
								</li>
								<li>
									<p class="p-lg">Increased cleaning and sanitizing of all touchable surfaces
										throughout the day</p>
								</li>
								<li>
									<p class="p-lg">Daily symptom checks with all staff</p>
								</li>
							</ul>
					...
					<div class="col-md-6 col-lg-4">
						<div class="cbox-3 text-center">
							...
							<div class="cbox-3-txt">
								...
								<!-- Phone -->
								<h6 class="h6-xl coffee-color">Phone: <span><a
											href="tel:123456789">789-654-3210</a></span></h6>
					...
					<div class="col-md-6 col-lg-4">
						<div class="cbox-3 text-center">
							...
							<div class="cbox-3-txt">
								...
								<!-- Phone -->
								<h6 class="h6-xl coffee-color">Phone: <span><a
											href="tel:123456789">789-456-0123</a></span></h6>
					...
					<div class="col-md-6 col-lg-4">
						<div class="cbox-3 text-center">
							...
							<div class="cbox-3-txt">
								...
								<!-- Phone -->
								<h6 class="h6-xl coffee-color">Phone: <span><a
											href="tel:123456789">789-645-0123</a></span></h6>
